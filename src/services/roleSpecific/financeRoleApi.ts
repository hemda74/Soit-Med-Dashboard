// Finance role-specific user creation API services (Finance Manager, Finance Employee)
...
export const createFinanceManager = async (
	...
	console.log(
		'Using endpoint:',
		API_ENDPOINTS.ROLE_SPECIFIC_USER.FINANCE_MANAGER
	);
...
export const createFinanceEmployee = async (
	...
	console.log(
		'Using endpoint:',
		API_ENDPOINTS.ROLE_SPECIFIC_USER.FINANCE_EMPLOYEE
	);
