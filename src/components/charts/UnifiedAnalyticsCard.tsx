                    ...
                    {activeTab === 'departments' && departmentData && (
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <h4 className="text-sm font-medium text-gray-900">Department Breakdown</h4>
                                <div className="grid grid-cols-2 gap-2">
                                    {departmentData.labels.map((department, index) => {
                                        ...
                                        return (
                                            <div key={department} className="flex items-center justify-between text-xs p-2 bg-gray-50 rounded">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="text-gray-500 w-8 text-right">{percentage}%</span>
                                                </div>
                                            </div>
                                        );
                                    })}
