export const translations = {
	en: {
		...
		clientEquipmentVisits: 'Clients & Equipment',
		maintenanceDashboard: 'Maintenance Dashboard',
		manageYourMedicalEquipmentMaintenance: 'Manage your medical equipment maintenance operations',
		totalCustomers: 'Total Customers',
		totalEquipment: 'Total Equipment',
		activeVisits: 'Active Visits',
		completionRate: 'Completion Rate',
		maintenanceRecentActivityPlaceholder: 'Recent activity will be shown here. Click on a customer to view their details.',
		maintenanceVisitStatus: 'Visit Status',
		contractTotalValue: 'Total Value',
		contractRenewalRate: 'Renewal Rate',
		systemHealth: 'System Health',
		apiResponseTime: 'Response Time',
		customerManagement: 'Customer Management',
		searchCustomers: 'Search customers...',
		addCustomer: 'Add Customer',
		equipmentOverview: 'Equipment Overview',
		equipmentManagementPlaceholder: 'Equipment management interface coming soon...',
		visitSchedule: 'Visit Schedule',
		visitManagementPlaceholder: 'Visit management interface coming soon...',
	...
	ar: {
		...
		clientEquipmentVisits: 'العملاء والمعدات',
		maintenanceDashboard: 'لوحة تحكم الصيانة',
		manageYourMedicalEquipmentMaintenance: 'إدارة عمليات صيانة المعدات الطبية',
		totalCustomers: 'إجمالي العملاء',
		totalEquipment: 'إجمالي المعدات',
		activeVisits: 'الزيارات النشطة',
		completionRate: 'معدل الإنجاز',
		maintenanceRecentActivityPlaceholder: 'سيتم عرض النشاط الأخير هنا. انقر على عميل لعرض تفاصيله.',
		maintenanceVisitStatus: 'حالة الزيارة',
		contractTotalValue: 'القيمة الإجمالية',
		contractRenewalRate: 'معدل التجديد',
		systemHealth: 'صحة النظام',
		apiResponseTime: 'وقت الاستجابة',
		customerManagement: 'إدارة العملاء',
		searchCustomers: 'البحث عن العملاء...',
		addCustomer: 'إضافة عميل',
		equipmentOverview: 'نظرة عامة على المعدات',
		equipmentManagementPlaceholder: 'واجهة إدارة المعدات قريباً...',
		visitSchedule: 'جدول الزيارات',
		visitManagementPlaceholder: 'واجهة إدارة الزيارات قريباً...',
